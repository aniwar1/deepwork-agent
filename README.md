# Deepwork-Agent：企业级端到端通用智能体平台

## 一、产品定位

**Deepwork-Agent** 是一个面向企业级应用的端到端通用智能体（End-to-End Universal Agent）平台，采用多智能体架构，基于 Spring AI 生态构建，深度融合大语言模型（LLM）能力与现代软件工程架构，提供从感知、推理到执行的全链路智能化解决方案。
...
Deepwork-Agent 代表了企业级智能体平台的发展方向：
...
Deepwork-Agent 不仅是一个工具平台，更是企业智能化转型的**核心基础设施**，为构建下一代 AI 原生应用提供坚实底座。